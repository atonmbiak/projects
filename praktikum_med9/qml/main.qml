    ...
    RenderWindow {
        ...
        MouseArea {
            ...
            onPositionChanged: {
                ...
                {
                    myDicomPipeline.level = myDicomPipeline.level + (mouse.x < 0? 5:-5);
                    myDicomPipeline.window = myDicomPipeline.window + (mouse.x < 0? 5:-5);
                    console.log("level: " + myDicomPipeline.level);
                    console.log("window: " + myDicomPipeline.window);
                }
